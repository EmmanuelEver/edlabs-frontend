...
const JoinSectionView: FC<IProps> = ({showAddModal, handleSetShowModal}) => {
  return (
    <>
        <button onClick={() => handleSetShowModal(true)} className="flex ml-auto text-sm leading-none text-light-100 items-center font-medium justify-center rounded py-2.5 transition-colors px-4 bg-dark-header hover:text-header hover:bg-accentColor-200">
